...
def read_wind(file1, file2):
    ...
    if 'swe' or 'SWE' in file1:
        swe = file1
        mag = file2
        print(type(swe['Proton_W_moment'][1]))
...
file1 = pd.read_csv('WI_H1_SWE_1933802.csv', delimiter=',', header=0, parse_dates=['Time'])
file2 = pd.read_csv('WI_H0_MFI_1933802.csv', delimiter=',', header=0, parse_dates=['Time'])
